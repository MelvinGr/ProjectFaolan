			...
			switch ((PlayerAgentOpcodes)packet.Opcode)
			{
				...
				case PlayerAgentOpcodes.EnterWorld:
				{
					...
					SendGameServer(client);
                        ...
                        var headerData638167354496472670 = new byte[] { 0x0D, 0x38, 0x57, 0x15, 0x7D, 0x10, 0x01, 0x20, 0xE3, 0xEE, 0x9F, 0xE2, 0x07 };
