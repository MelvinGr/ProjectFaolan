...
namespace Faolan.PlayerAgent
{
	partial class PlayerAgentListener
	{
        ...
        {
            var sender638167354496472670 = new byte[] { 0x0D, 0x16, 0x91, 0x35, 0x1D, 0x10, 0x5A };
        ...
        private void SendGameServer(INetworkClient client)
		{
            ...
            var headerData638172634263791750_0_0 = new byte[] { 0x0D, 0x38, 0x57, 0x15, 0x7D, 0x10, 0x01, 0x20, 0xF9, 0xD8, 0xD9, 0xC5, 0x0D };

            var packetData638172634263791750_0_0 = new byte[]
            {
                0x62, 
                0x00, 0x00, 0xC7, 0x9C, 
                0x00, 0x00, 0x07, 0xD0, 
