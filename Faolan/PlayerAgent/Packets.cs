...
namespace Faolan.PlayerAgent
{
    partial class PlayerAgentListener
    {
        ...
        public void InitAuth(INetworkClient client)
        {
            byte[] headerData = {0x93, 0x86, 0xee, 0x05};

            new PacketStream()
                .WriteHeader(Sender, Receiver, headerData, PlayerAgentRespondseOpcodes.InitAuth)
                .WriteUInt32(client.Account.AuthStatus)
                .Send(client);
        }

        public void SendSmallCharList(INetworkClient client)
        {
            var characters = client.Account.GetCharacters(Database);
            var anzChars = (uint) characters.Length;

            byte[] headerData = {0x94, 0xa7, 0x60};

            var aBuffer = new PacketStream();
            aBuffer.WriteHeader(Sender, Receiver, headerData, PlayerAgentRespondseOpcodes.SmallCharList);
        ...
        public void SendCharacterList(INetworkClient client, IDatabase database)
        {
            var characters = client.Account.GetCharacters(Database);
            byte[] headerData = {0x8b, 0xd3, 0xa0, 0x0c};

            var aBuffer = new PacketStream();
            aBuffer.WriteHeader(Sender, Receiver, headerData, PlayerAgentRespondseOpcodes.SendCharacterList);
            ...
            aBuffer.WriteUInt32(client.Account.Id);
            aBuffer.WriteUInt32(0x00000000);
        ...
        public void SendRealmList(INetworkClient client)
        {
            byte[] headerData = {0xe2, 0xe6, 0xc4, 0x0f};

            var aBuffer = new PacketStream();
            aBuffer.WriteHeader(Sender, Receiver, headerData, PlayerAgentRespondseOpcodes.SendRealmList);
            // SetDimensionList
        ...
        public void Request_Char_RealmData_1(INetworkClient client)
        {
            byte[] headerData = {0xcb, 0xc6, 0xfc, 0x04};

            new PacketStream()
                .WriteHeader(Sender, Receiver, headerData, PlayerAgentRespondseOpcodes.SendCharacterRealmData)
                .WriteUInt32(1)
                .Send(client);
        }

        public void Ox20a6_1(INetworkClient client)
        {
        ...
        public void SendCsPlayerAgent(INetworkClient client)
        {
            ...
            new PacketStream() // send CSPlayerAgent
                .WriteHeader(Sender3, Receiver3, headerdata0, PlayerAgentRespondseOpcodes.SendCsPlayerAgent)
                .WriteUInt32(Functions.htonl(Functions.inet_addr(Settings.CsPlayerAgentAddress)))
        ...
        public void SendAgentServer(INetworkClient client)
        {
            ...
            new PacketStream() // Send PlayerAgent
                .WriteHeader(Sender0, Receiver0, headerdata0, PlayerAgentRespondseOpcodes.SendAgentServer)
                .WriteUInt32(Functions.htonl(Functions.inet_addr(Settings.AgentServerAddress)))
        ...
        public void SendGameServer(INetworkClient client)
        {
            // fs21.bin_2
            ...
            new PacketStream() // Send WorldServer
                .WriteHeader(Sender3, Receiver3, headerData, PlayerAgentRespondseOpcodes.SendGameServer)
        ...
        public void SendLast(INetworkClient client)
        {
            // fs21.bin_3
            var headerData = new byte[]
            ...
            new PacketStream()
                .WriteHeader(Sender3, Receiver3, headerData, PlayerAgentRespondseOpcodes.SendLast)
        ...
        public void EnterWorld(INetworkClient client)
        {
            ...
            /*client.Account.ClientInstance = (uint) Database.ExecuteScalar<long>(
                "SELECT clientinst FROM clientinstances " +
                "WHERE accountid=" + client.Account.Id + " AND characterid=" + client.Character.Id);*/

            new PacketStream()
                .WriteHeader(Sender4, Receiver4, headerData, PlayerAgentRespondseOpcodes.EnterWorld)
                .WriteUInt32(0x0000C350)
                .WriteUInt32(client.Account.ClientInstance)
                .WriteArray(packetData)
                .Send(client);
