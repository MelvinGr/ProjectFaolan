	...
	case 0x03: //Authenticate2
		{
			...
			if(true) //cGameClientVersionString == settings.clientVersion)
			{
				...
				if(client->charInfo.level > 0)
				{
					...
					{
						/*
						EnterWorld.setItemStats(client, 0x00000005, 0x000e6241);
						EnterWorld.setItemStats(client, 0x00000006, 0x000e6242);
						EnterWorld.setItemStats(client, 0x00000010, 0x000e6243);
						EnterWorld.setItemStats(client, 0x00000012, 0x000e6244);
						//*/
					}
					uint32 size=0;
