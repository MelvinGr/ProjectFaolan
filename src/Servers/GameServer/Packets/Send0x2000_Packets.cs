...
namespace GameServer
{
    ...
    {
        private void SendPlayerRelated0X2000(NetworkClient client, Account account)
        {
            ...
            new PacketStream()
                .WriteHeader(Sender0, Receiver0, null, 0x2000)
                .WriteArrayPrependLengthUInt32(new ConanStream()
                    .WriteUInt32(Ox2000RespondsOpcodes.Ox6B87E316)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteUInt16(0x0000)
                    .WriteUInt32(0x02387E00)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteArray(packetData1372))
                .Send(client);
            ...
            new PacketStream()
                ...
                .WriteArrayPrependLengthUInt32(new ConanStream()
                    ...
                    .WriteUInt32(account.ClientInstance)
                    .WriteUInt16(0x0000)
                    .WriteUInt32(0x0365D300)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteArray(packetData1382))
                .Send(client);
            ...
            new PacketStream()
                ...
                .WriteArrayPrependLengthUInt32(new ConanStream()
                    ...
                    .WriteUInt32(account.ClientInstance)
                    .WriteUInt16(0x0000)
                    .WriteUInt32(0x31EB1500)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteArray(packetData1392))
                .Send(client);
            ...
            new PacketStream()
                ...
                .WriteArrayPrependLengthUInt32(new ConanStream()
                    ...
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteUInt32(0x00003DFA)
                    .WriteUInt16(0x4800)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
                    .WriteArray(packetData1402))
                .Send(client);
            ...
            new PacketStream()
                .WriteHeader(Sender0, Receiver0, null, 0x2000)
                .WriteArrayPrependLengthUInt32(new ConanStream()
                    .WriteUInt32(Ox2000RespondsOpcodes.Ox96B8DC59)
                    .WriteUInt32(0x0000C350)
                    .WriteUInt32(account.ClientInstance)
        ...
        private void Send0x5D85BFC7(NetworkClient client)
        {
        ...
        private void SpawnPlayer(NetworkClient client, Account account)
        {
