...
namespace Faolan.Core.Network
{
    public static class PacketUtils
    {
        ...
        public static string PacketToCsCode(ConanPacket packet, int? index = null)
        {
            ...
            return
                ...
                (packet.Data != null
                    ? $"var packetData{indexStr} = new byte[]{packet.Data.ToArray().ToHex()};\r\n"
                    : "") +
                ...
                (packet.Data != null ? $"\t.WriteArray(packetData{indexStr})\r\n" : "") +
                ".Send(client);\r\n";
        }
